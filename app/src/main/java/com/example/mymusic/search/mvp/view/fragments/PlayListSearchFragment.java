...
import com.example.mymusic.search.adapter.PlayListSearchAdapter;
...
public class PlayListSearchFragment extends BaseFragment<SearchPresenter> implements SearchContract.View {
