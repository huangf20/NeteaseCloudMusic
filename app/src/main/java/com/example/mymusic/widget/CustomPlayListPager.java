...
public class CustomPlayListPager extends ViewGroup {
    ...
    public CustomPlayListPager(Context context) {
        this(context, null);
    }

    public CustomPlayListPager(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomPlayListPager(Context context, AttributeSet attrs, int defStyleAttr) {
