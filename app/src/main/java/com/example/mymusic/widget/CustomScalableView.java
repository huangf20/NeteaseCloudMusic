...
public class CustomScalableView extends View {
    ...
    public CustomScalableView(Context context) {
        this(context, null);
    }

    public CustomScalableView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomScalableView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
